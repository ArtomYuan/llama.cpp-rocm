...
static fattn_vec_case_t ggml_cuda_get_fattn_vec_case(const int64_t head_size, const ggml_type type_K, const ggml_type type_V) {
    ...
    // ROCmFP4 / ROCmFPx (local fusion fork): FA vector instances are compiled
    // unconditionally (see ggml-cuda/CMakeLists.txt), so their diagonal K/V
    // combinations are always registered here.
    FATTN_VEC_CASES_ALL_D(Q4_0_ROCMFP4,      Q4_0_ROCMFP4)
    FATTN_VEC_CASES_ALL_D(Q4_0_ROCMFP4_FAST, Q4_0_ROCMFP4_FAST)
    FATTN_VEC_CASES_ALL_D(Q3_0_ROCMFPX,      Q3_0_ROCMFPX)
    FATTN_VEC_CASES_ALL_D(Q6_0_ROCMFPX,      Q6_0_ROCMFPX)
    FATTN_VEC_CASES_ALL_D(Q8_0_ROCMFPX,      Q8_0_ROCMFPX)
...
static bool ggml_cuda_fattn_kv_type_supported(const ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q5_1:
        case GGML_TYPE_Q8_0:
        // ROCmFP4 / ROCmFPx (local fusion fork): dispatched by the is_rocmfp_family
        // path in ggml_cuda_get_best_fattn_kernel; FA vector instances compiled.
        case GGML_TYPE_Q4_0_ROCMFP4:
        case GGML_TYPE_Q4_0_ROCMFP4_FAST:
        case GGML_TYPE_Q3_0_ROCMFPX:
        case GGML_TYPE_Q6_0_ROCMFPX:
        case GGML_TYPE_Q8_0_ROCMFPX:
        // TurboQuant KV (local fusion fork): dispatched via
        // ggml_cuda_fattn_turbo_vec_fused_eligible / turbo_batched_required.
