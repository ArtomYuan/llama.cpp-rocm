...
uint32_t llama_context::output_reserve(int32_t n_outputs) {
    ...
    // embeddings mode never consumes the full-vocab logits (callers read t_embd / t_embd_pooled),
    // so skip the n_vocab*n_outputs host buffer and its D2H copy entirely.
